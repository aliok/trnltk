...
class PrimaryPosition:
    ...
    ALL = sorted({NOUN, ADJECTIVE, ADVERB, CONJUNCTION, INTERJECTION, VERB, PRONOUN, NUMERAL, DETERMINER, PARTICLE})
...
class SecondaryPosition:
    ...
    ALL = sorted({DUPLICATOR, POST_POSITIVE, QUESTION, DEMONSTRATIVE, PERSONAL, TIME, PROPER_NOUN})
