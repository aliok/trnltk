...
class ContextParsingLikelihoodCalculator(object):
    ...
    def _count_surface_given_leading_surface(self, leading_surface_str, leading_surface_syn_cat, surface_str, surface_syntactic_category):
        ...
        query_surface_given_leading_surface = WordBigramQueryBuilder().surface(surface_str, surface_syntactic_category).given_surface(leading_surface_str, leading_surface_syn_cat).build()
    ...
    def _count_stem_given_leading_surface(self, leading_surface_str, leading_surface_syn_cat, stem_str, stem_syntactic_category):
        ...
        query_stem_given_leading_surface = WordBigramQueryBuilder().stem(stem_str, stem_syntactic_category).given_surface(leading_surface_str, leading_surface_syn_cat).build()
    ...
    def _count_lexeme_given_leading_surface(self, leading_surface_str, leading_surface_syn_cat, lemma_root_str, lemma_root_syntactic_category):
        ...
        query_lexeme_given_leading_surface = WordBigramQueryBuilder().lemma_root(lemma_root_str, lemma_root_syntactic_category).given_surface(leading_surface_str, leading_surface_syn_cat).build()
    ...
    def _count_surface_given_leading_stem(self, leading_stem_str, leading_stem_syn_cat, surface_str, surface_syntactic_category):
        ...
        query_surface_given_leading_stem = WordBigramQueryBuilder().surface(surface_str, surface_syntactic_category).given_stem(leading_stem_str, leading_stem_syn_cat).build()
    ...
    def _count_stem_given_leading_stem(self, leading_stem_str, leading_stem_syn_cat, stem_str, stem_syntactic_category):
        ...
        query_stem_given_leading_stem = WordBigramQueryBuilder().stem(stem_str, stem_syntactic_category).given_stem(leading_stem_str, leading_stem_syn_cat).build()
    ...
    def _count_lexeme_given_leading_stem(self, leading_stem_str, leading_stem_syn_cat, lemma_root_str, lemma_root_syntactic_category):
        ...
        query_lexeme_given_leading_stem = WordBigramQueryBuilder().lemma_root(lemma_root_str, lemma_root_syntactic_category).given_stem(leading_stem_str, leading_stem_syn_cat).build()
    ...
    def _count_surface_given_leading_lexeme(self, leading_lemma_root_str, leading_lemma_root_syn_cat, surface_str, surface_syntactic_category):
        ...
        query_surface_given_leading_lexeme = WordBigramQueryBuilder().surface(surface_str, surface_syntactic_category).given_lemma_root(leading_lemma_root_str, leading_lemma_root_syn_cat).build()
    ...
    def _count_stem_given_leading_lexeme(self, leading_lemma_root_str, leading_lemma_root_syn_cat, stem_str, stem_syntactic_category):
        ...
        query_stem_given_leading_lexeme = WordBigramQueryBuilder().stem(stem_str, stem_syntactic_category).given_lemma_root(leading_lemma_root_str, leading_lemma_root_syn_cat).build()
    ...
    def _count_lexeme_given_leading_lexeme(self, leading_lemma_root_str, leading_lemma_root_syn_cat, lemma_root_str, lemma_root_syntactic_category):
        ...
        query_lexeme_given_leading_lexeme = WordBigramQueryBuilder().lemma_root(lemma_root_str, lemma_root_syntactic_category).given_lemma_root(leading_lemma_root_str, leading_lemma_root_syn_cat).build()
    ...
    def _p_word_given_leading_surface(self, morpheme_container, surface_str, surface_syn_cat, stem_str, stem_syn_cat, lemma_root_str, lemma_root_syn_cat):
        ...
        count_surface_given_leading_surface = self._count_surface_given_leading_surface(leading_surface_str, leading_surface_syn_cat, surface_str, surface_syn_cat)
        ...
        count_lexeme_given_leading_surface = self._count_lexeme_given_leading_surface(leading_surface_str, leading_surface_syn_cat, lemma_root_str, lemma_root_syn_cat)
    ...
    def _p_word_given_leading_lexeme(self, morpheme_container, surface_str, surface_syn_cat, stem_str, stem_syn_cat, lemma_root_str, lemma_root_syn_cat):
        ...
        count_surface_given_leading_lexeme = self._count_surface_given_leading_lexeme(leading_lemma_root_str, leading_lemma_root_syn_cat, surface_str, surface_syn_cat)
        ...
        count_lexeme_given_leading_lexeme = self._count_lexeme_given_leading_lexeme(leading_lemma_root_str, leading_lemma_root_syn_cat, lemma_root_str, lemma_root_syn_cat)
    ...
    def likelihood(self, parse_results_of_leading_word, lemma_root_str, lemma_root_syn_cat, stem_str, stem_syn_cat, surface_str, surface_syn_cat):
        ...
        for morpheme_container in parse_results_of_leading_word:
            p_word_given_leading_surface = self._p_word_given_leading_surface(morpheme_container, surface_str, surface_syn_cat, stem_str, stem_syn_cat, lemma_root_str, lemma_root_syn_cat)
            p_word_given_leading_stem = self._p_word_given_leading_stem(morpheme_container, surface_str, surface_syn_cat, stem_str, stem_syn_cat, lemma_root_str, lemma_root_syn_cat)
            p_word_given_leading_lexeme = self._p_word_given_leading_lexeme(morpheme_container, surface_str, surface_syn_cat, stem_str, stem_syn_cat, lemma_root_str, lemma_root_syn_cat)
