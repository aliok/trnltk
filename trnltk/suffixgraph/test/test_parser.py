...
#        self.assert_parse_correct(u'yaparlardı',        u'yap(yapmak)+Verb+Pos+Aor(+Ar[ar])+Past(dI[dı])+A3sg')    ##TODO
    ...
    def test_should_parse_reflexive_pronouns(self):
        self.assert_parse_correct(u'kendim',             u'kendi(kendi)+Pron+Reflex+A1sg+P1sg(+Im[m])+Nom')
        self.assert_parse_correct(u'kendin',             u'kendi(kendi)+Pron+Reflex+A2sg+P2sg(+In[n])+Nom')
        self.assert_parse_correct(u'kendi',              u'kendi(kendi)+Pron+Reflex+A3sg+P3sg+Nom')
        self.assert_parse_correct(u'kendimiz',           u'kendi(kendi)+Pron+Reflex+A1pl+P1pl(+ImIz[miz])+Nom')
        self.assert_parse_correct(u'kendiniz',           u'kendi(kendi)+Pron+Reflex+A2pl+P2pl(+InIz[niz])+Nom')
        ...
        self.assert_parse_correct(u'kendimi',            u'kendi(kendi)+Pron+Reflex+A1sg+P1sg(+Im[m])+Acc(+yI[i])')
        self.assert_parse_correct(u'kendini',            u'kendi(kendi)+Pron+Reflex+A2sg+P2sg(+In[n])+Acc(+yI[i])', u'kendi(kendi)+Pron+Reflex+A3sg+P3sg+Acc(nI[ni])')
        self.assert_parse_correct(u'kendimizi',          u'kendi(kendi)+Pron+Reflex+A1pl+P1pl(+ImIz[miz])+Acc(+yI[i])')
        self.assert_parse_correct(u'kendinizi',          u'kendi(kendi)+Pron+Reflex+A2pl+P2pl(+InIz[niz])+Acc(+yI[i])')
        ...
        self.assert_parse_correct(u'kendilerimizi',      u'kendi(kendi)+Pron+Reflex+A1pl(ler[ler])+P1pl(+ImIz[imiz])+Acc(+yI[i])')
        self.assert_parse_correct(u'kendilerinizi',      u'kendi(kendi)+Pron+Reflex+A2pl(ler[ler])+P2pl(+InIz[iniz])+Acc(+yI[i])')

        self.assert_parse_correct(u'kendime',            u'kendi(kendi)+Pron+Reflex+A1sg+P1sg(+Im[m])+Dat(+yA[e])')
        self.assert_parse_correct(u'kendine',            u'kendi(kendi)+Pron+Reflex+A2sg+P2sg(+In[n])+Dat(+yA[e])', u'kendi(kendi)+Pron+Reflex+A3sg+P3sg+Dat(nA[ne])')
        self.assert_parse_correct(u'kendimize',          u'kendi(kendi)+Pron+Reflex+A1pl+P1pl(+ImIz[miz])+Dat(+yA[e])')
        self.assert_parse_correct(u'kendinize',          u'kendi(kendi)+Pron+Reflex+A2pl+P2pl(+InIz[niz])+Dat(+yA[e])')
        self.assert_parse_correct(u'kendilerine',        u'kendi(kendi)+Pron+Reflex+A3pl(leri[leri])+P3pl+Dat(nA[ne])')
        self.assert_parse_correct(u'kendisine',          u'kendi(kendi)+Pron+Reflex+A3sg+P3sg(+sI[si])+Dat(nA[ne])')
        self.assert_parse_correct(u'kendilerimize',      u'kendi(kendi)+Pron+Reflex+A1pl(ler[ler])+P1pl(+ImIz[imiz])+Dat(+yA[e])')
        self.assert_parse_correct(u'kendilerinize',      u'kendi(kendi)+Pron+Reflex+A2pl(ler[ler])+P2pl(+InIz[iniz])+Dat(+yA[e])')

        self.assert_parse_correct(u'kendimde',           u'kendi(kendi)+Pron+Reflex+A1sg+P1sg(+Im[m])+Loc(dA[de])')
        self.assert_parse_correct(u'kendinde',           u'kendi(kendi)+Pron+Reflex+A2sg+P2sg(+In[n])+Loc(dA[de])', u'kendi(kendi)+Pron+Reflex+A3sg+P3sg+Loc(ndA[nde])')
        self.assert_parse_correct(u'kendimizde',         u'kendi(kendi)+Pron+Reflex+A1pl+P1pl(+ImIz[miz])+Loc(dA[de])')
        self.assert_parse_correct(u'kendinizde',         u'kendi(kendi)+Pron+Reflex+A2pl+P2pl(+InIz[niz])+Loc(dA[de])')
        self.assert_parse_correct(u'kendilerinde',       u'kendi(kendi)+Pron+Reflex+A3pl(leri[leri])+P3pl+Loc(ndA[nde])')
        self.assert_parse_correct(u'kendisinde',         u'kendi(kendi)+Pron+Reflex+A3sg+P3sg(+sI[si])+Loc(ndA[nde])')
        self.assert_parse_correct(u'kendilerimizde',     u'kendi(kendi)+Pron+Reflex+A1pl(ler[ler])+P1pl(+ImIz[imiz])+Loc(dA[de])')
        self.assert_parse_correct(u'kendilerinizde',     u'kendi(kendi)+Pron+Reflex+A2pl(ler[ler])+P2pl(+InIz[iniz])+Loc(dA[de])')

        self.assert_parse_correct(u'kendimden',          u'kendi(kendi)+Pron+Reflex+A1sg+P1sg(+Im[m])+Abl(dAn[den])')
        self.assert_parse_correct(u'kendinden',          u'kendi(kendi)+Pron+Reflex+A2sg+P2sg(+In[n])+Abl(dAn[den])', u'kendi(kendi)+Pron+Reflex+A3sg+P3sg+Abl(ndAn[nden])')
        self.assert_parse_correct(u'kendimizden',        u'kendi(kendi)+Pron+Reflex+A1pl+P1pl(+ImIz[miz])+Abl(dAn[den])')
        self.assert_parse_correct(u'kendinizden',        u'kendi(kendi)+Pron+Reflex+A2pl+P2pl(+InIz[niz])+Abl(dAn[den])')
        self.assert_parse_correct(u'kendilerinden',      u'kendi(kendi)+Pron+Reflex+A3pl(leri[leri])+P3pl+Abl(ndAn[nden])')
        self.assert_parse_correct(u'kendisinden',        u'kendi(kendi)+Pron+Reflex+A3sg+P3sg(+sI[si])+Abl(ndAn[nden])')
        self.assert_parse_correct(u'kendilerimizden',    u'kendi(kendi)+Pron+Reflex+A1pl(ler[ler])+P1pl(+ImIz[imiz])+Abl(dAn[den])')
        self.assert_parse_correct(u'kendilerinizden',    u'kendi(kendi)+Pron+Reflex+A2pl(ler[ler])+P2pl(+InIz[iniz])+Abl(dAn[den])')

        self.assert_parse_correct(u'kendimin',           u'kendi(kendi)+Pron+Reflex+A1sg+P1sg(+Im[m])+Gen(+nIn[in])')
        self.assert_parse_correct(u'kendinin',           u'kendi(kendi)+Pron+Reflex+A2sg+P2sg(+In[n])+Gen(+nIn[in])', u'kendi(kendi)+Pron+Reflex+A3sg+P3sg+Gen(+nIn[nin])')
        self.assert_parse_correct(u'kendimizin',         u'kendi(kendi)+Pron+Reflex+A1pl+P1pl(+ImIz[miz])+Gen(+nIn[in])')
        self.assert_parse_correct(u'kendinizin',         u'kendi(kendi)+Pron+Reflex+A2pl+P2pl(+InIz[niz])+Gen(+nIn[in])')
        ...
        self.assert_parse_correct(u'kendilerimizin',     u'kendi(kendi)+Pron+Reflex+A1pl(ler[ler])+P1pl(+ImIz[imiz])+Gen(+nIn[in])')
        self.assert_parse_correct(u'kendilerinizin',     u'kendi(kendi)+Pron+Reflex+A2pl(ler[ler])+P2pl(+InIz[iniz])+Gen(+nIn[in])')

        self.assert_parse_correct(u'kendimle',           u'kendi(kendi)+Pron+Reflex+A1sg+P1sg(+Im[m])+Ins(+ylA[le])')
        self.assert_parse_correct(u'kendinle',           u'kendi(kendi)+Pron+Reflex+A2sg+P2sg(+In[n])+Ins(+ylA[le])')
        self.assert_parse_correct(u'kendiyle',           u'kendi(kendi)+Pron+Reflex+A3sg+P3sg+Ins(+ylA[yle])')
        self.assert_parse_correct(u'kendimizle',         u'kendi(kendi)+Pron+Reflex+A1pl+P1pl(+ImIz[miz])+Ins(+ylA[le])')
        self.assert_parse_correct(u'kendinizle',         u'kendi(kendi)+Pron+Reflex+A2pl+P2pl(+InIz[niz])+Ins(+ylA[le])')
        self.assert_parse_correct(u'kendileriyle',       u'kendi(kendi)+Pron+Reflex+A3pl(leri[leri])+P3pl+Ins(+ylA[yle])')
        self.assert_parse_correct(u'kendisiyle',         u'kendi(kendi)+Pron+Reflex+A3sg+P3sg(+sI[si])+Ins(+ylA[yle])')
        self.assert_parse_correct(u'kendilerimizle',     u'kendi(kendi)+Pron+Reflex+A1pl(ler[ler])+P1pl(+ImIz[imiz])+Ins(+ylA[le])')
        self.assert_parse_correct(u'kendilerinizle',     u'kendi(kendi)+Pron+Reflex+A2pl(ler[ler])+P2pl(+InIz[iniz])+Ins(+ylA[le])')
