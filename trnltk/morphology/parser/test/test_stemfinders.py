...
from trnltk.morphology.stem.dictionaryitem import SecondarySyntacticCategory
from trnltk.morphology.parser.stemfinder import NumeralStemFinder, ProperNounFromApostropheStemFinder, ProperNounWithoutApostropheStemFinder
